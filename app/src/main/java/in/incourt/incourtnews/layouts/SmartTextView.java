...
public class SmartTextView extends AppCompatTextView {
    ...
    private void initialize(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            if (attrArray != null) {
                mJustified = attrArray.getBoolean(R.styleable.SmartTextView_justified, true);
                mFontType = FontType.values()[attrArray.getInt(R.styleable.SmartTextView_fontname, 0)];
